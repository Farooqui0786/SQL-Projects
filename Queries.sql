...
FROM
    PIZZAS
        JOIN
    PIZZA_TYPES ON PIZZAS.PIZZA_TYPE = PIZZA_TYPES.PIZZA_TYPE
...
FROM
    PIZZA_TYPES
        JOIN
    PIZZAS ON PIZZA_TYPES.PIZZA_TYPE = PIZZAS.PIZZA_TYPE
        JOIN
...
-- 6.Join the necessary details to find the total quantity of each pizza category ordered.
SELECT 
...
FROM
    PIZZA_TYPES
        JOIN
    PIZZAS ON PIZZAS.PIZZA_TYPE = PIZZA_TYPES.PIZZA_TYPE
        JOIN
    ORDER_DETAILS ON PIZZAS.PIZZA_ID = ORDER_DETAILS.PIZZA_ID
GROUP BY PIZZA_TYPES.NAME
